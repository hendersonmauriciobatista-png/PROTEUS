...
class RelatoriosPage(QWidget):
    ...
    def _build_report(self):
        ...
        fora_padrao = sum(1 for row in qualidade_rows if self._quality_status(row) == "Fora do padrão")
        ...
        lines = [
            ...
            "",
            "QUALIDADE DA ÁGUA",
            f"- Registros fora do padrão: {fora_padrao}",
    ...
    def _format_latest_quality(self, rows):
        ...
        return (
            ...
            f"Status {self._quality_status(latest)}"
        )
